...
F((w[0].A=U)_(w[0].fog_end=1100)_((fog_color=d[3].S[5])>-1)_(t=9))L(d[++t]!=0)F(dt.A=dt.l)P(dt,H);
L(f<4){B(c<d[3].S[f+1]);
t=9+5*f++;
L(d[++t]!=0)P(dt,H);
...
L(d2.A>0)X(d2.A,-T(3))+0*(d2.J+=T(.05))*(d2.K-=T(.02))*m;
F(!C(d2,H))W(-1);
P(d3,H);
L(d3.S[11]<32){W(-.125);
...
Y.z=Y.S[4]+10*Z(O*3)*T1+0*(Y.a=cycle(Y.a+T(2),0,U)+0*ent_animate(Y,"f",Y.a,1));
F((Y.l+=T1)>48)Y.l-=48+0*e(ee,300,Y.S[5],MM(normal,10));
t=20;
E(d[20].x,V(d[20].x,-260+5*N(O*5),5*Z(O*4)));
L(++t<24){dt.y=230+40*N(O*10+120*(t-21))+0*(dt.z=3*N(O*40+90*(t-21)));
F(s>1_ f<3)F((X(dt.A,-T(10)))==0)F((dt.a+=T1)>4)dt.A=90+0*(dt.K*=-1)*(dt.a-=4);
}X(d[n].A,-T(16));
...
L(s<2){F((M.l+=T1)>5)M.l-=5+0*e(pe,15,M.x,d[0].a);
...
F((d[15].l+=T1)>96)d[16].y-=d[16].a*T1+0*(d[15].y=d[16].y*-1);
...
m;
sh();	
L(s<5){F(!f)F((w[1].A=minv(U,w[1].A+T1))==U)reset(w[1],1024);
F(s==0||f==4){M.v+=T(18)*((s==0)-(f==4));
E(w[1].h,V(50*(N(2*O))*(s==0)+(w[1].h+T(3))*(f==4),-90+15*Z(3*O),0));
E(w[1].x,V(70*N(3*O),2688+(70+90*(f==4))*Z(3*O),592));
}F((s==0||s==4)_ c>9_(M.l+=T1)>3)M.l%=3+0*e(ei,10,M.a,d[0].a)*e(es,6,M.S[1+s],M.S[8+s]);
m;
}}