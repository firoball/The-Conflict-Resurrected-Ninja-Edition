...
}I(ee)F((aa=pa)q,2100480)))p.A=25+R(25)+0*(kk(p.vel_x,UU(V(R2,R2,R(20)),R(50)))).x*(E(p.blue,d[2].a)).x;
}I(pe)F((aa=mw)q,2304))_(p.z+=30)S3)p.A=45+0*(E(p.blue,d[4].a)).x*(E(p.vel_x,V(R2,R2,3.5+R(1.5)))).x;
}I(es)F(!(aa=0)q,2099456))S3 _(p.vel_z*=8+R(4)))p.A=20+R(10)+0*(E(p.blue,d[1].a)).x*(kk(p.x,V(R(220)-110,R(1400)-700,0))).x;
}I(ei)F((aa=pa)q,2097408))S3)p.A=25+R(25)+0*(kk(p.vel_x,UU(V(R2,R2,R2),R(150)))).x*(E(p.blue,d[1].a)).x;
}D fa(){m;
