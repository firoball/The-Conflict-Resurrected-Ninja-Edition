...
}I(ee)F((aa=pa)q,2100480)))p.A=25+R(25)+0*(kk(p.vel_x,U(V(R(2)-1,R(2)-1,R(20)),R(50)))).x*(E(p.blue,V(20,110,150))).x;
}I(pe)F((aa=mw)q,2304))_(p.lifespan=60)&&(p.size=2))p.A=45+0*(E(p.blue,V(180,80,62))).x*(E(p.vel_x,V(-1+R(2),-1+R(2),3.5+R(1.5)))).x;
}I(es)F(!(aa=0)q,2099456))&&(p.size=4)&&(p.vel_z*=8+R(4)))p.A=20+R(10)+0*(E(p.blue,V(255,255,255))).x*(kk(p.x,V(R(220)-110,R(1400)-700,0))).x;
}I(ei)F((aa=pa)q,2097408))&&(p.size=2))p.A=25+R(25)+0*(kk(p.vel_x,U(V(R(2)-1,R(2)-1,R(2)-1),R(150)))).x*(E(p.blue,V(255,255,255))).x;
}D fa(){W(1);
...
B(s<4);
sm(5);
}D main(){F((t=-1)&&(d3d_antialias=9)&&(video_mode=12*video_screen=1)&&(w[0]=view_create(-1))&&(w[1]=camera))W(1);
...
}D set_sprite(){F(G=M.S[1])L(s<3)F(W(1)&&(G=minv(G+T(.8),57))>=57)G=0*W(-2);
}D set_heaven(){B(f<1);
